...
# from https://github.com/Kaixhin/PlaNet
# TODO remove jit references
...
class VisualObservationModel(jit.ScriptModule):
  ...
  def __init__(self, image_channels, belief_size, state_size, embedding_size, activation_function='relu'):
    super().__init__()
    self.act_fn = getattr(F, activation_function)
...
class VisualEncoder(jit.ScriptModule):
  ...
  def __init__(self, image_channels, embedding_size, activation_function='relu'):
    super().__init__()
    self.act_fn = getattr(F, activation_function)
    self.embedding_size = embedding_size
